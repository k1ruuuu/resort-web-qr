                ...
                <tbody>
                    @forelse($logs as $log)
                        <tr>
                            ...
                            <td>
                                <strong>{{ $log->guest_name ?? $log->guest?->full_name ?? $log->guestVoucher?->guest_name ?? 'N/A' }}</strong>
                                <span class="d-block small text-muted">Booking: {{ $log->booking_code ?? ($log->booking ? ($log->booking->booking_code ?? $log->booking->reference) : ($log->guest_voucher_id ? 'Temporary Voucher' : 'N/A')) }}</span>
                            </td>
