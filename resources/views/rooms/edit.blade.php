            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select name="bed_type" class="form-select @error('bed_type') is-invalid @enderror">
                            ...
                            <option value="KS" @if(old('bed_type', $room->bed_type) === 'KS') selected @endif>King Size (KS)</option>
                            <option value="QS" @if(old('bed_type', $room->bed_type) === 'QS') selected @endif>Queen Bed Single (QS)</option>
                            <option value="SB" @if(old('bed_type', $room->bed_type) === 'SB') selected @endif>Single Bed (SB)</option>
                            <option value="TB" @if(old('bed_type', $room->bed_type) === 'TB') selected @endif>Twin Bed (TB)</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select name="room_view" class="form-select @error('room_view') is-invalid @enderror">
                            ...
                            <option value="Pool View" @if(old('room_view', $room->room_view) === 'Pool View') selected @endif>Pool View</option>
                            <option value="Forest View" @if(old('room_view', $room->room_view) === 'Forest View') selected @endif>Forest View</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', $room->location) }}" placeholder="e.g. 1">
