    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow">
            <div class="card-body">
                ...
                @include('vouchers.partials.verification-panel')
            </div>
        </div>
    ...
    function displayVerification(data) {
        ...
        data.facilities.forEach(facility => {
            ...
            if (facility.operating_hours) {
                ...
                hoursEl.appendChild(clockIcon);
                hoursEl.appendChild(document.createTextNode(' ' + facility.operating_hours));
                if (isClosed) {
                    const tutupBadge = document.createElement('span');
                    tutupBadge.className = 'badge bg-danger text-white ms-1';
                    tutupBadge.textContent = 'Tutup';
                    hoursEl.appendChild(document.createTextNode(' '));
                    hoursEl.appendChild(tutupBadge);
                }
