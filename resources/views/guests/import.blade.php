...
@section('page_title', 'Import Guests')
@section('content')
    ...
    <div class="col-md-8 col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    <a href="{{ route('guests.download-template') }}" class="btn btn-outline-primary">
                        <i class="fas fa-download"></i> Download Template
                    </a>
                </div>

                <form method="POST" action="{{ route('guests.process-import') }}" enctype="multipart/form-data">
                    @csrf
