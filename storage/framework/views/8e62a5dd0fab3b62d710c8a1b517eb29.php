...
<?php $__env->startSection('title', 'Import Rooms'); ?>
<?php $__env->startSection('page_title', 'Import Rooms'); ?>
    ...
    <div class="col-md-8 col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    <a href="<?php echo e(route('rooms.download-template')); ?>" class="btn btn-outline-primary">
                        <i class="fas fa-download"></i> Download Template
                    </a>
                </div>

                <form method="POST" action="<?php echo e(route('rooms.process-import')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\rooms\import.blade.php ENDPATH**/ ?>