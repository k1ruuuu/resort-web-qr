        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <p><strong>Status:</strong> 
                    ...
                    ?>
                    <span class="badge bg-<?php echo e($statusBadge); ?> text-white"><?php echo e(ucwords(str_replace('_', ' ', $booking->status->value))); ?></span>
                </p>
                ...
                <?php if($booking->room && $booking->room->room_view): ?><p><strong>Room View:</strong> <?php echo e($booking->room->room_view); ?></p><?php endif; ?>
                <?php if($booking->room && $booking->room->bed_type): ?><p><strong>Bed Type:</strong> <?php echo e($booking->room->bed_type); ?></p><?php endif; ?>
                <?php if($booking->room && $booking->room->location): ?><p><strong>Location:</strong> Zone <?php echo e($booking->room->location); ?></p><?php endif; ?>
                <?php if($booking->arrangement_code): ?><p><strong>Arrangement Code:</strong> <?php echo e($booking->arrangement_code); ?></p><?php endif; ?>
...
<div class="card mt-3">
    <div class="card-header font-weight-bold <?php echo e($booking->guestVoucher->status->value === 'active' ? 'bg-primary text-white' : 'bg-secondary text-white'); ?>">
        ...
        ?>
        <span class="badge bg-<?php echo e($voucherBadge); ?> text-white float-end"><?php echo e(ucfirst($booking->guestVoucher->status->value)); ?></span>
    </div>
    <div class="card-body">
...
<?php endif; ?>
            ...
            <div class="col-md-8">
                ...
                <p class="mb-1"><strong>Status:</strong> <span class="badge bg-<?php echo e($voucherBadge); ?> text-white"><?php echo e(ucfirst($booking->guestVoucher->status->value)); ?></span></p>
...
<div class="modal fade" id="checkinFacilitiesModal" tabindex="-1" aria-labelledby="checkinFacilitiesModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('bookings.check-in', $booking)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($facilityTemplates->isNotEmpty()): ?>
                        ...
                        <div class="bg-light border rounded p-3">
                            <?php if($facilityTemplates->isNotEmpty()): ?>
                                <?php $__currentLoopData = $facilityTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facilityTemplate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input facility-checkbox" type="checkbox" name="facility_template_ids[]" value="<?php echo e($facilityTemplate->id); ?>" id="facility_<?php echo e($facilityTemplate->id); ?>" <?php if($booking->bookingFacilities->contains('facility_template_id', $facilityTemplate->id)): echo 'checked'; endif; ?>>
                                        <label class="form-check-label" for="facility_<?php echo e($facilityTemplate->id); ?>">
                                            <?php echo e($facilityTemplate->name); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\bookings\show.blade.php ENDPATH**/ ?>