            ...
            <table class="table table-striped mb-0">
                <thead>
                    <tr>
                        ...
                        <th>Code</th>
                        <th>Property</th>
                        <th class="table-col-hide-sm">Sort Order</th>
                        <th>Status</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="table-col-hide-sm"><?php echo e($facility->sort_order); ?></td>
                        <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\facilities\index.blade.php ENDPATH**/ ?>