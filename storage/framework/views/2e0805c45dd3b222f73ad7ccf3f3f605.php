                ...
                <div id="scanner-section">
                    <div class="mb-3">
                        ...
                        <select id="outlet-select" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $propertyName => $propertyOutlets): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <optgroup label="<?php echo e($propertyName); ?>">
                                <?php $__currentLoopData = $propertyOutlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($outlet->id); ?>" data-facility="<?php echo e($outlet->facilityTemplates->first()?->name); ?>">
                                    <?php echo e($outlet->name); ?> (<?php echo e($outlet->facilityTemplates->first()?->code); ?>)
                                </option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\vouchers\redeem.blade.php ENDPATH**/ ?>