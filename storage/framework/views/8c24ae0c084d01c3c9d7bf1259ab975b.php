                    ...
                    <li class="list-group-item d-flex justify-content-between">
                        ...
                        <span>
                            <?php if($voucher->booking): ?>
                                <?php echo e($voucher->booking->total_pax); ?> (+ <?php echo e($voucher->booking->extra_beds); ?> Extra Bed) = <strong><?php echo e($voucher->booking->total_pax + $voucher->booking->extra_beds); ?> Quota</strong>
                            <?php else: ?>
                                1
                            <?php endif; ?>
                        </span>
