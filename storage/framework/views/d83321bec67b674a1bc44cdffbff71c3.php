        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    <div>
                        <strong>Total Records:</strong> <?php echo e($logs->total()); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.export-button','data' => ['route' => 'reports.scan-history.export','filters' => request()->only(['search', 'scan_result', 'outlet_id', 'date_from', 'date_to']),'text' => 'Export Scan History']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['route' => 'reports.scan-history.export','filters' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->only(['search', 'scan_result', 'outlet_id', 'date_from', 'date_to'])),'text' => 'Export Scan History']); ?>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span class="badge bg-<?php echo e($badgeClass); ?> text-white"><?php echo e($displayText); ?></span>
                                    </td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\reports\scan-history.blade.php ENDPATH**/ ?>