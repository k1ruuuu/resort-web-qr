...
<div class="mb-3 d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2">
    <div class="d-flex gap-2 flex-wrap">
        ...
        <a href="<?php echo e(route('guests.import')); ?>" class="btn btn-outline-primary btn-responsive">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\guests\index.blade.php ENDPATH**/ ?>