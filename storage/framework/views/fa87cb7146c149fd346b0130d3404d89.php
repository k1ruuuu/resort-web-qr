            ...
            <table class="table table-hover table-striped mb-0">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $vouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voucher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><code class="text-mono small"><?php echo e(substr($voucher->qr_code, 0, 12)); ?><?php echo e(strlen($voucher->qr_code) > 12 ? '...' : ''); ?></code></td>
                        ...
                        <td>
                            <a href="<?php echo e(route('vouchers.show', $voucher)); ?>" class="btn btn-sm btn-outline-primary" title="View">
                                <i class="fas fa-qrcode"></i>
                            </a>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vouchers.edit')): ?>
                                <a href="<?php echo e(route('vouchers.edit', $voucher)); ?>" class="btn btn-sm btn-outline-warning" title="Edit Facilities">
