            ...
            <div class="card-body">
                ...
                <table class="table table-sm">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($room->bed_type ?? '—'); ?></td>
                    </tr>
                    <tr>
                        <td class="fw-bold">Room View:</td>
                        <td><?php echo e($room->room_view ?? '—'); ?></td>
                    </tr>
                    <tr>
                        <td class="fw-bold">Location:</td>
                        <td><?php echo e($room->location ? 'Zone ' . $room->location : '—'); ?></td>
                    </tr>
                    <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\rooms\show.blade.php ENDPATH**/ ?>