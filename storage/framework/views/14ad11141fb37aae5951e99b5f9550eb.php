...
<?php $__env->startSection('page_title', 'Create Property'); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <?php $__currentLoopData = timezone_identifiers_list(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tz); ?>" <?php if(old('timezone') === $tz): ?> selected <?php endif; ?>><?php echo e($tz); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                <div class="form-check">
                    ...
                    <input type="checkbox" name="is_active" value="1" class="form-check-input" <?php if(old('is_active', true)): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\properties\create.blade.php ENDPATH**/ ?>