...
<?php $__env->startSection('page_title', 'Edit Role: ' . $role->name); ?>
                            ...
                            <div class="col-md-4 col-sm-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="permissions[]" value="<?php echo e($permission->name); ?>" id="perm_<?php echo e($permission->id); ?>" 
                                        <?php echo e((is_array(old('permissions')) && in_array($permission->name, old('permissions'))) || (!is_array(old('permissions')) && $role->hasPermissionTo($permission->name)) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views\roles\edit.blade.php ENDPATH**/ ?>