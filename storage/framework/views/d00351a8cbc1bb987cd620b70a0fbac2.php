...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/chanaya-logo.png')); ?>" type="image/png">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/theme-forest.css')); ?>">
</head>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="<?php echo e(route('dashboard')); ?>" class="brand-link">
            <img src="<?php echo e(asset('img/chanaya-logo.png')); ?>" alt="Logo" class="brand-image" style="opacity: .9; max-height: 52px; width: auto;">
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('docs')); ?>" class="nav-link <?php if(request()->routeIs('docs')): ?> active <?php endif; ?>">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('outlets.index')); ?>" class="nav-link <?php if(request()->routeIs('outlets.*')): ?> active <?php endif; ?>">
...
<?php /**PATH C:\Users\thinkpad\Documents\Pawbxj\resort-web-qr\resources\views/layouts/app.blade.php ENDPATH**/ ?>